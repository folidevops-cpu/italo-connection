              ...
              <div class="flex-1">
                ...
                <div class="space-y-4">
                  <InputsTextField
                    ...
                    hint="Enter a direct link to your profile picture (JPG, PNG, or GIF)"
                  />
                    ...
                    <div class="flex">
                      ...
                      <div class="ml-3">
                        <p class="text-sm text-blue-700">
                          <strong>Tips:</strong> Use services like  <a href="https://postimages.org" target="_blank" class="underline">PostImages</a> to host your photo and get a direct link.
                        </p>
                      </div>
                    </div>
                  </div>
